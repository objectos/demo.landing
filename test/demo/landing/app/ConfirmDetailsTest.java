...
import demo.landing.app.ConfirmDetails.Item;
import java.util.List;
import java.util.Optional;
import org.testng.annotations.Test;

public class ConfirmDetailsTest extends AbstractTest {

  @Test
  public void testCase01() {
    final Optional<ConfirmDetails> maybe;
    maybe = ConfirmDetails.queryOptional(trx, 901);

    assertEquals(maybe.isPresent(), true);

    final ConfirmDetails model;
    model = maybe.get();
    ...
    assertEquals(model.totalPrice(), 19.98);
